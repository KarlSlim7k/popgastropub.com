...
<input className="w-full bg-surface-container-high border-none border-b border-outline-variant/30 text-on-surface py-3 focus:ring-0 focus:border-secondary transition-all" type="password" value="*************************"/>
</div>
<div className="group">
