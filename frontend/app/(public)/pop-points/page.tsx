    ...
    <main className="min-h-screen bg-[#0D0D0D] pt-28 md:pt-36 pb-32">
      ...
      <section className="relative py-32 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <motion.span
            ...
            className="text-[11px] font-black uppercase tracking-[0.4em] text-[#F2C777]/60 mb-4 block"
          >
            Programa de Lealtad
          </motion.span>
          <motion.h1
            ...
            className="text-6xl md:text-9xl font-black tracking-tighter text-white leading-none mb-6"
          >
          ...
          >
            <a href="/login?tab=register" className="inline-flex items-center gap-2 bg-[#D96725] hover:bg-[#F2C777] hover:text-[#0D0D0D] text-white font-black uppercase tracking-widest text-sm px-10 py-5 rounded-lg transition-all duration-300 hover:shadow-[0_0_30px_rgba(217,103,37,0.35)] hover:scale-[1.02]">
              <span className="material-symbols-outlined">stars</span>
              Únete Gratis — Gana 50 pts
            </a>
            <a href="/login" className="inline-flex items-center gap-2 border border-[#F2C777]/20 text-[#F2C777] font-bold text-sm px-8 py-5 rounded-lg hover:bg-[#F2C777]/10 transition-all">
              Ya tengo cuenta
            </a>
          </motion.div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-black text-white tracking-tighter text-center mb-4"
        >
        ...
        >
          Mientras más puntos acumules, mejores beneficios desbloqueas.
        </motion.p>
        <motion.div
        ...
        >
          {TIERS.map((tier) => (
            <motion.div
              ...
              className="bg-[#1C1C1C] border border-white/5 rounded-xl p-8 hover:border-white/10 transition-all duration-300 group"
            >
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 border-t border-white/5">
        ...
        <motion.p
          ...
          className="text-white/50 text-center mb-16 max-w-lg mx-auto"
        >
          Múltiples formas de acumular puntos en cada interacción con POP.
        </motion.p>
        <motion.div
          variants={containerVariants}
          initial="hidden"
        ...
        >
          {EARN_ACTIONS.map((item) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              transition={{ duration: 0.3 }}
              className="bg-[#1C1C1C] border border-white/5 rounded-lg p-6 flex flex-col items-center text-center hover:border-[#F2C777]/20 transition-all"
            >
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 border-t border-white/5">
        <motion.h2
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7, ease: [0.23, 1, 0.32, 1] }}
          className="text-4xl font-black text-white tracking-tighter text-center mb-16"
        >
          ¿Cómo Funciona?
        </motion.h2>
        <motion.div
      ...
      <section className="max-w-3xl mx-auto px-6 py-20 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7, ease: [0.23, 1, 0.32, 1] }}
          className="bg-gradient-to-br from-[#1C1C1C] to-[#0D0D0D] border border-[#F2C777]/10 rounded-2xl p-12 md:p-16 hover:border-[#F2C777]/25 transition-colors duration-500"
        >
          ...
          <a href="/login?tab=register" className="inline-flex items-center gap-2 bg-[#D96725] hover:bg-[#F2C777] hover:text-[#0D0D0D] text-white font-black uppercase tracking-widest text-sm px-12 py-5 rounded-lg transition-all duration-300 hover:shadow-[0_0_40px_rgba(217,103,37,0.3)] hover:scale-[1.02]">
            Crear Cuenta Gratis
          </a>
        </motion.div>
      </section>
