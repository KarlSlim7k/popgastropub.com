  ...
  return (
    <main className="bg-[#0D0D0D] pt-20">
      ...
      <section className="max-w-7xl mx-auto px-6 -mt-32 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 h-[600px] bg-[#1C1C1C] rounded-lg overflow-hidden relative">
        ...
        <div className="lg:col-span-4">
          <div className="bg-[#1C1C1C] p-8 rounded-lg border-t-2 border-[#F2C777]/20">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <a className="bg-[#D96725] p-8 rounded-lg flex flex-col justify-between h-48 transition-all duration-500 hover:-translate-y-2" href="https://www.google.com/maps/dir/?api=1&destination=POP+Perote,+Justo+Sierra+No.+11,+Col.+Amado+Nervo,+Perote,+Veracruz" target="_blank" rel="noopener noreferrer">
          ...
          <a className="bg-[#1C1C1C] border border-white/5 p-8 rounded-lg flex flex-col justify-between h-48 transition-all duration-500 hover:-translate-y-2" href="tel:2828253243">
