...
<a className="group relative overflow-hidden bg-primary p-8 flex flex-col justify-between h-48 transition-all duration-500 hover:-translate-y-2" href="#">
...
<a className="group relative overflow-hidden bg-surface-container-high p-8 flex flex-col justify-between h-48 transition-all duration-500 hover:-translate-y-2 border border-secondary/10" href="#">
...
<a className="group relative overflow-hidden bg-surface-container-low p-8 flex flex-col justify-between h-48 transition-all duration-500 hover:-translate-y-2 border border-on-surface/5" href="#">
...
<input className="w-full bg-transparent border-0 border-b border-outline-variant py-4 focus:ring-0 focus:border-secondary transition-all text-on-surface placeholder:text-on-surface/30" placeholder="Nombre Completo" type="text"/>
</div>
<div className="relative">
<input className="w-full bg-transparent border-0 border-b border-outline-variant py-4 focus:ring-0 focus:border-secondary transition-all text-on-surface placeholder:text-on-surface/30" placeholder="Teléfono" type="tel"/>
</div>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
<div className="relative">
<input className="w-full bg-transparent border-0 border-b border-outline-variant py-4 focus:ring-0 focus:border-secondary transition-all text-on-surface" type="date"/>
</div>
<div className="relative">
<input className="w-full bg-transparent border-0 border-b border-outline-variant py-4 focus:ring-0 focus:border-secondary transition-all text-on-surface" type="time"/>
</div>
...
<button className="text-secondary" type="button"><span className="material-symbols-outlined">remove_circle</span></button>
<span className="font-headline font-bold text-xl tabular-nums">2</span>
<button className="text-secondary" type="button"><span className="material-symbols-outlined">add_circle</span></button>
</div>
</div>
</div>
<div className="relative">
<textarea className="w-full bg-transparent border-0 border-b border-outline-variant py-4 focus:ring-0 focus:border-secondary transition-all text-on-surface placeholder:text-on-surface/30 resize-none" placeholder="Notas especiales (Alergias, cumpleaños...)" rows={3}></textarea>
</div>
