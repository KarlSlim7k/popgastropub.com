        ...
        <div className="px-4 sm:px-8 max-w-7xl mx-auto text-center py-24 relative z-10">
          ...
          >
            ...
            <p className="text-[#e5e2e1]/50 text-lg max-w-lg mx-auto mb-8">
              Estamos preparando nuevas promociones exclusivas para ti. ¡No te las pierdas!
            </p>
            <a
              href="https://wa.me/522821278014?text=Hola%20POP%20Perote,%20quiero%20recibir%20las%20promociones%20exclusivas"
              target="_blank"
