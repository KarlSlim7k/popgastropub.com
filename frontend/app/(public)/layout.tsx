...
export default function PublicLayout({
  ...
  return (
    <>
      ...
      {/* Mobile Nav */}
      <nav className="public-mobile-bottom-nav md:hidden fixed bottom-0 left-0 w-full z-50 grid grid-cols-5 items-center py-3 pb-safe bg-[#0D0D0D]/95 backdrop-blur-xl border-t border-[#F2C777]/10 shadow-[0_-10px_30px_rgba(217,103,37,0.08)]">
        <a
