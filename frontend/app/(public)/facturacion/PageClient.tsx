    ...
    return (
      <main className="min-h-screen bg-[#234032] pt-24 pb-32">
        ...
        <div className="max-w-2xl mx-auto px-4 md:px-8 text-center">
          ...
          <a
            href="/login"
            className="inline-flex items-center gap-2 bg-[#D96E30] hover:bg-[#F2C166] hover:text-[#234032] text-white font-black uppercase tracking-widest px-8 py-4 transition-all"
          >
            Iniciar Sesión
          </a>
        </div>
    ...
    <main className="min-h-screen bg-[#234032] pt-24 pb-32">
      ...
      <section className="relative overflow-hidden py-20 px-6 md:px-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-epilogue text-5xl md:text-7xl font-black tracking-tighter text-white leading-none mb-6">
            SOLICITAR{' '}
            <span className="text-[#F2C166]">FACTURA</span>
          </h1>
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-3 space-y-6">
              ...
              <div className="bg-[#1C3028] p-6 md:p-8">
                ...
                <label
                  ...
                  className={`flex flex-col items-center justify-center gap-4 border-2 border-dashed p-10 md:p-16 cursor-pointer transition-all duration-300 ${
                    dragOver
                      ? 'border-[#F2C166] bg-[#F2C166]/5'
                      : 'border-[#F2C166]/20 hover:border-[#F2C166]/50 hover:bg-[#F2C166]/5'
                  }`}
                >
                  <span className="material-symbols-outlined text-[#F2C166] text-5xl">receipt</span>
                  ...
                  <span className="bg-[#D96E30] hover:bg-[#F2C166] hover:text-[#234032] text-white font-black text-sm px-6 py-3 transition-colors flex items-center gap-2">
            ...
            {/* ESTADO: Subiendo */}
            {step === 'uploading' && (
              <div className="bg-[#1C3028] p-8 flex flex-col items-center gap-6">
                <div className="relative w-16 h-16">
                  <div className="absolute inset-0 rounded-full border-4 border-[#F2C166]/20" />
                  <div className="absolute inset-0 rounded-full border-4 border-t-[#F2C166] animate-spin" />
                  <span className="absolute inset-0 flex items-center justify-center material-symbols-outlined text-[#F2C166] text-2xl">cloud_upload</span>
                </div>
                <div className="text-center">
                  <p className="text-white font-bold">Analizando ticket...</p>
                  <p className="text-white/40 text-sm mt-1">{fileName}</p>
                </div>
                <div className="w-full bg-[#234032] h-1 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-[#D96E30] to-[#F2C166] animate-[progress_1.8s_ease-in-out_forwards] w-0" />
                </div>
              </div>
            )}
            ...
            {(step === 'form' || step === 'submitting' || step === 'done' || step === 'error') && (
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Ticket adjunto */}
                <div className="bg-[#1C3028] px-5 py-4 flex items-center justify-between gap-4">
                ...
                <div className="bg-[#1C3028] p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-8">
                    <span className="material-symbols-outlined text-[#F2C166] text-2xl">description</span>
                    <h2 className="font-epilogue font-black text-white text-xl uppercase tracking-tight">
                      Datos Fiscales
                    </h2>
                  </div>
                  ...
                  <div className="space-y-5">
                    <div>
                      <label className="block text-[10px] font-black uppercase tracking-widest text-[#F2C166]/70 mb-2">
                        RFC *
                      </label>
                      <input
                        name="rfc"
                        ...
                        maxLength={13}
                        className="w-full bg-transparent border-b border-[#F2C166]/20 py-3 text-white placeholder:text-white/25 focus:border-[#F2C166] focus:outline-none transition-colors uppercase font-mono text-sm"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-transparent border-b border-[#F2C166]/20 py-3 text-white placeholder:text-white/25 focus:border-[#F2C166] focus:outline-none transition-colors text-sm"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <select
                          name="regimen_fiscal"
                          required
                          className="w-full bg-[#1C3028] border-b border-[#F2C166]/20 py-3 text-white/80 focus:border-[#F2C166] focus:outline-none transition-colors text-sm appearance-none cursor-pointer"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          pattern="[0-9]{5}"
                          placeholder="00000"
                          className="w-full bg-transparent border-b border-[#F2C166]/20 py-3 text-white placeholder:text-white/25 focus:border-[#F2C166] focus:outline-none transition-colors font-mono text-sm"
                        />
                      </div>
                      <div>
                        <label className="block text-[10px] font-black uppercase tracking-widest text-[#F2C166]/70 mb-2">
                  ...
                  {step === 'form' && (
                    <button
                      type="submit"
                      className="w-full mt-6 bg-[#D96E30] hover:bg-[#F2C166] hover:text-[#234032] text-white font-black uppercase tracking-widest py-4 flex items-center justify-center gap-3 transition-all duration-300 active:scale-95"
                    >
                  ...
                  {step === 'submitting' && (
                    <div className="mt-6 flex items-center justify-center gap-4 py-4 border border-[#F2C166]/20">
                      <div className="w-5 h-5 border-2 border-t-[#F2C166] border-[#F2C166]/20 rounded-full animate-spin" />
                      <span className="text-[#F2C166] font-black uppercase text-sm tracking-widest">Enviando solicitud...</span>
                    </div>
                  )}
                ...
                {step === 'done' && (
                  <div className="bg-[#1C3028] p-6 md:p-8">
                    ...
                    <button
                      type="button"
                      onClick={reset}
                      className="mt-6 w-full border border-[#F2C166]/30 text-[#F2C166] hover:bg-[#F2C166]/10 font-black uppercase tracking-widest py-3 transition-colors"
                    >
          ...
          <aside className="lg:col-span-2 space-y-6">
            <div className="bg-[#1C3028] p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <span className="material-symbols-outlined text-[#F2C166] text-base mt-0.5">store</span>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <span className="material-symbols-outlined text-[#F2C166] text-base mt-0.5">location_on</span>
            ...
            <div className="bg-[#2E592D] border border-[#F2C166]/10 p-6">
              <div className="flex items-center gap-2 mb-4">
                <span className="material-symbols-outlined text-[#D96E30] text-xl">info</span>
              ...
              <ul className="space-y-2 text-xs text-white/50 leading-relaxed">
                <li className="flex gap-2"><span className="text-[#F2C166] flex-shrink-0">→</span> RFC y Razón Social deben coincidir <strong className="text-white/70">exactamente</strong> con el SAT.</li>
                <li className="flex gap-2"><span className="text-[#F2C166] flex-shrink-0">→</span> Solo se expiden facturas en el <strong className="text-white/70">mes en curso</strong>.</li>
                <li className="flex gap-2"><span className="text-[#F2C166] flex-shrink-0">→</span> El ticket debe ser <strong className="text-white/70">legible</strong> y mostrar el folio y monto.</li>
              </ul>
            </div>
            ...
            <div className="bg-[#1C3028] p-6">
              ...
              <div className="space-y-1">
                {faqs.map((faq, i) => (
                  <div key={i} className="border-b border-[#F2C166]/8 last:border-0">
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <span className={`material-symbols-outlined text-[#F2C166] text-base flex-shrink-0 transition-transform duration-200 ${openFaq === i ? 'rotate-180' : ''}`}>
                        expand_more
                      </span>
                    </button>
                    {openFaq === i && (
