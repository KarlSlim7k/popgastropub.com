...
interface Reserva { id: number; nombre: string; telefono?: string; email?: string; fecha: string; hora: string; personas: number; estado: string; notas?: string; mesa?: { numero: number } | null; }
                    ...
                    <tr key={r.id} className="hover:bg-white/[0.02]">
                      ...
                      <td className="py-6">
                        <div className="flex items-center gap-2">
                          ...
                          {r.mesa && <span className="px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest bg-pop-gold/10 text-pop-gold">Mesa {r.mesa.numero}</span>}
                        </div>
                        <p className="text-[10px] text-gray-500">{r.email}</p><p className="text-[10px] text-gray-500">{r.telefono}</p>
                      </td>
